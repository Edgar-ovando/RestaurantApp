...
struct AlertContext{
    ...
    static let invalidData = AlertItem(title: Text("⛔️ Server Error"),
                                              message: Text("The data received from the server was invalid. Please contact support."),
                                              dismissButton: .default(Text("Ok")))
    
    static let invalidResponse = AlertItem(title: Text("⛔️ Server Error"),
                                              message: Text("Invalid Response from the server. Please try again later or contact support."),
                                              dismissButton: .default(Text("Ok")))
    
    static let invalidURL = AlertItem(title: Text("⛔️ Server Error"),
                                              message: Text("Issue connecting to the server. Please try again later or contact support."),
                                              dismissButton: .default(Text("Ok")))
    
    static let unabletoComplete = AlertItem(title: Text("⛔️ Server Error"),
                                              message: Text("Unable to complete your request at this time. Please check your internet connection and try again."),
                                              dismissButton: .default(Text("Ok")))
    
    static let passwordMismatch = AlertItem(title: Text("⚠️ Error"),
